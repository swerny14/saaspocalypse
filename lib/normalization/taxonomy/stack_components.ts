...
export const STACK_COMPONENTS: StackComponent[] = [
  ...
  { slug: "fal-ai-api", display_name: "Fal.ai API", category: "ml", commoditization_level: 3, aliases: ["fal.ai api"] },
  ...
  { slug: "pytorch", display_name: "PyTorch", category: "ml", commoditization_level: 4, aliases: ["pytorch"] },
  ...
  { slug: "n8n", display_name: "n8n", category: "integrations", commoditization_level: 4, aliases: ["n8n (just use this instead)", "n8n"] },
  ...
  { slug: "ffmpeg", display_name: "FFmpeg", category: "infra", commoditization_level: 5, aliases: ["ffmpeg"] },
